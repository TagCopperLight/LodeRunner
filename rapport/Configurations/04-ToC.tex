%%% Custom ToC Entries %%%
\makeatletter
\patchcmd{\tableofcontents}{\contentsname}{\pdfbookmark[0]{Table of Contents Prout}{toc}\contentsname}{}{}
...
\newcommand{\glossarytoc}{\MakeLinkTarget*{glossary}\addcontentsline{toc}{frontmatter}{\glossaryname}}

\newcommand{\acronymtoc}{\MakeLinkTarget*{acronym}\addcontentsline{toc}{frontmatter}{\acronymname}}